...
The wireless communication between the Gateway and the wearable tags is implemented using the \textbf{NRF24L01 2.4 GHz transceiver module}. This module operates in the \textbf{2.4–2.5 GHz ISM band} and supports configurable data rates of \textbf{250 kbps, 1 Mbps, and 2 Mbps}, enabling low-latency and reliable communication.
